...
export const FRUIT_GUIDE_TABS = [
  ...
  // 获取方式：抓/进化 20 只对应精灵 → 找 NPC 兑换
  {
    ...
    entries: [
      ...
      },
      {
        ...
        unlock: '抓/进化 20 只锤头鹳',
        usedInPlan: '刷异色方案',
        tip: 'S2 翼系方案专属果实，100% 定向刷出恶魔叮异色',
      },
      {
        fruit: '恶魔叮果实',
        spirit: '恶魔叮',
        attrs: ['恶系', '翼系'],
        unlock: '抓/进化 20 只叮叮恶魔',
        usedInPlan: '刷异色方案',
        tip: 'S2 恶、翼双属性果实，可配合锤头鹳果实使用',
      },
      {
        fruit: '缇塔果实',
        spirit: '缇塔',
      ...
      },
      {
        ...
        unlock: '待游戏更新后补充',
        usedInPlan: '刷异色方案',
        tip: 'S2 赛季常驻异色，幽+草双属，可配合幽系/草系混刷方案',
      },
      {
        fruit: '锥尾羊果实',
        spirit: '锥尾羊',
      ...
      // ─── S3「铅字幻梦」赛季常驻异色（8只，S3 上线时取消注释即可恢复） ─────
      // {
      //   fruit: '海盔虫果实',
      //   spirit: '千棘盔',
      //   attrs: ['水系'],
      ...
      //   unlock: '待游戏更新后补充',
      //   usedInPlan: '刷异色方案',
      //   tip: 'S3 草系常驻异色，草系池可出伊贝粉粉/花衣蝶/稻草守护者/炮米花',
      // },
      // {
      //   fruit: '斑斑果实',
      //   spirit: '斑枭',
      ...
      },
      {
        ...
        entries: [
          ...
          },
          {
            ...
            location: '圣所前哨东北侧',
            usedInPlan: '刷异色方案',
            tip: '电+翼双属精灵，自身无异色，进电系池 100% 检索炫光迪迪',
          },
          {
            fruit: '裘洛果实',
            spirit: '裘洛',
  ...
  // ─── Tab 3：赛季&活动 ────────────────────────────────────────────────────────
  {
    ...
    desc: '赛季任务 / 活动赠送 / 战令购买',
    groups: [
      // ─── S3 奇遇精灵分组（S3 上线时取消整段注释即可恢复） ─────────────────
      // {
      //   id: 's3_season_task',
      //   label: 'S3「铅字幻梦」奇遇精灵',
      //   color: '#9C27B0',
      //   desc: '完成 S3 赛季任务后开放 · 各需捕捉 1 只奇异血脉的对应精灵',
      //   entries: [
      //     {
      //       fruit: '蜜果骸果实',
      //       spirit: '半朽蜜果灵',
      //       attrs: ['幽系'],
      //       unlock: '捕捉 1 只奇异血脉的半朽蜜果灵',
      //       usedInPlan: '刷异色方案',
      //       tip: '幽系池，100% 定向刷出半朽蜜果灵',
      //       fruitPending: true,  // S3 奇遇果实图官方暂未放出
      //     },
      //     {
      //       fruit: '栗鼠果实',
      //       spirit: '壳栗丝鼠',
      //       attrs: ['毒系'],
      //       unlock: '捕捉 1 只奇异血脉的壳栗丝鼠',
      //       usedInPlan: '刷异色方案',
      //       tip: '毒系池，可出壳栗丝鼠/千棘盔/蝴蝶陶陶',
      //       fruitPending: true,
      //     },
      //     {
      //       fruit: '稻草人果实',
      //       spirit: '稻草守护者',
      //       attrs: ['萌系'],
      //       unlock: '捕捉 1 只奇异血脉的稻草守护者',
      //       usedInPlan: '刷异色方案',
      //       tip: '萌系池，可出稻草守护者/蝴蝶陶陶',
      //     },
      //     {
      //       fruit: '蝴蝶陶陶果实',
      //       spirit: '蝴蝶陶陶',
      //       attrs: ['萌系'],
      //       unlock: '捕捉 1 只奇异血脉的蝴蝶陶陶',
      //       usedInPlan: '刷异色方案',
      //       tip: '萌系池，可与稻草人果实混刷',
      //     },
      //     {
      ...
      //       spirit: '深渊蛙',
      //       attrs: ['水系'],
      //       unlock: '捕捉 1 只奇异血脉的深渊蛙',
      //       usedInPlan: '刷异色方案',
      //       tip: '水系池，可出千棘盔/龙鱼/深渊蛙',
      //     },
      //     {
      //       fruit: '卡波果实',
      //       spirit: '卡拉波斯',
      //       attrs: ['恶系'],
      //       unlock: '捕捉 1 只奇异血脉的卡拉波斯',
      //       usedInPlan: '刷异色方案',
      //       tip: '恶系池，100% 定向刷出卡拉波斯（卡波→卡拉波斯）',
      //     },
      //     {
      //       fruit: '苞米仔果实',
      //       spirit: '炮米花',
      //       attrs: ['草系'],
      //       unlock: '捕捉 1 只奇异血脉的炮米花',
      //       usedInPlan: '刷异色方案',
      //       tip: '草系池，可出伊贝粉粉/花衣蝶/稻草守护者/炮米花',
      //       fruitPending: true,
      //     },
      //     {
      //       fruit: '守夜烛果实',
      //       spirit: '流明坎德拉',
      //       attrs: ['火系', '机械系'],
      //       unlock: '捕捉 1 只奇异血脉的流明坎德拉',
      //       usedInPlan: '刷异色方案',
      //       tip: 'S3 火+机械双属奇遇精灵，可进火系或机械系池刷取',
      //     },
      //   ],
      // },
      {
        ...
        entries: [
          {
            ...
            usedInPlan: '刷异色方案',
            tip: '小丑豆豆→小丑兔→小丑公爵，恶系池可刷出小丑公爵异色',
          },
          {
            fruit: '小鼓象果实',
            spirit: '小鼓象',
          ...
          },
          {
            ...
            usedInPlan: '刷异色方案',
            tip: '烟花团→烟花图案→烟花伯爵，火+毒双属池可刷出烟花伯爵异色',
          },
          {
            fruit: '牵线木偶果实',
            spirit: '帅帅魔偶',
          ...
          },
          {
            ...
            usedInPlan: '刷异色方案',
            tip: '猴麦仔→音碟吼，普通+机械双属，可进普通系或机械系池刷取',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        entries: [
          ...
          //   unlock: '购买 S3 战令礼包',
          //   usedInPlan: '刷异色方案',
          //   tip: 'S3 战令限定，只能单刷；机械系池可出离心舞者 / 流明坎德拉（足尖元件→离心舞者）',
          //   fruitPending: true,  // S3 战令果实图官方暂未放出
          // },
          // {
          //   fruit: '咬咬小子果实',
          //   spirit: '胡桃王子',
          ...
          //   unlock: '购买 S3 战令礼包',
          //   usedInPlan: '刷异色方案',
          //   tip: 'S3 战令限定，只能单刷；100% 定向刷出胡桃王子（咬咬小子→胡桃王子）',
          //   fruitPending: true,  // S3 战令果实图官方暂未放出
          // },
          {
            fruit: '绒绒果实',
          ...
          },
          {
            ...
            unlock: '购买战令礼包',
            usedInPlan: '刷异色方案',
            tip: 'S2 战令限定，冰系单刷异色专属；小雪人→雪怪进化链',
          },
          {
            fruit: '爆焰喷喷果实',
            spirit: '爆焰喷喷',
